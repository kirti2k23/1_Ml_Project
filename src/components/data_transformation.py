...
class DataTransformation:
    def __init__(self):
        self.data_tranformation = DataTransformationConfig()

    def get_data_transformation_obj(self):
        """This function is responsible for data tarnsformation"""
        try:
            ...
            preprocessor = ColumnTransformer(
                [
                    ("num pipepline",numerical_pipeline,numerical_columns),
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            save_object(
                ...
                file_path=self.data_tranformation.preprocessor_obj_file_path,
            ...
            return (
                train_arr,
                test_arr,
                self.data_tranformation.preprocessor_obj_file_path,
            )
